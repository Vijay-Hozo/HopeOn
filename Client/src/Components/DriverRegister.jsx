...
const UserRegister = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-950 w-ful">
      <DriverHeader />
      <div className='flex flex-col md:flex-row items-center justify-center bg-blue-950 text-white p-4'>
        {/* Image Section */}
        <div className='w-full md:w-1/2 flex justify-center items-center p-6'>
          <img src={Signupimage} alt='Sign up' className='w-full h-auto max-w-md hidden md:block' />
        </div>

        {/* Form Section */}
        <form
          className='flex flex-col items-center text-xl gap-4 max-h-full w-full md:w-1/2 text-white py-5 px-4'
        ...
        >
          ...
          <div className='flex flex-col md:flex-row justify-between gap-4 md:gap-20 my-2 w-full'>
            <input
              type='text'
              className='p-2 rounded-xl bg-gray-600 bg-opacity-10 w-full md:w-1/2'
          ...
          <div className='flex flex-col md:flex-row justify-between gap-4 md:gap-20 my-4 w-full'>
            <input
              type='number'
              className='p-2 rounded-xl bg-gray-600 bg-opacity-10 w-full md:w-1/2'
          ...
          <div className='w-full'>
            ...
            <input
              type='file'
              className='text-white p-2 rounded-xl w-full bg-gray-600 bg-opacity-10'
          ...
          <div className='w-full'>
            <input
              type='password'
              className='p-2 rounded-xl bg-gray-600 bg-opacity-10 w-full'
