            ...
            <ul className='flex justify-between gap-4'>
               ...
               <Link to="/driverlogin">DriverLogin</Link>
                <Link to="/allrides"><li>All Rides</li></Link>
                 ...
                 {
                    token ? 
                    <Link to="/userlogin"><li><img src={logout} alt="" className='w-14 h-8' onClick={handleLogout} /></li></Link>
                    :
                    <Link to="/allrides"><li><img src={loginimage} alt="" className='w-8' /></li></Link>
